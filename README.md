...
> In this project, We are creating an Enumerable with ruby
...
- Use the url to clone the repo https://github.com/Booze33/MyEnumerable.git

Example commands:

```sh
  cd my-folder
https://github.com/Booze33/MyEnumerable.git
```
